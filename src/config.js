...
export const appConfig = {
  ...
  physics: {
    ...
    sphereContactSkin: 0.015,
    boundaryContainmentEnabled: true,
    boundaryContainmentInset: 0.005,
    staticBaseColliderThickness: 0.4,
    ...
    shakeMinPointerSpeed: 3.2,
    shakeVerticalVelocityScale: 0.6,
    shakeVortexLiftMultiplier: 0.25,
    shakeVortexInwardMultiplier: 0.35,
    shakePressureEnabled: true,
    shakePressureCellSizeRatio: 0.22,
    shakePressureMinBodies: 4,
    shakePressureFullStrengthBodies: 8,
    shakePressureAcceleration: 2.2,
